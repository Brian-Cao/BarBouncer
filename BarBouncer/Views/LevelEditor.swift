...
//        angleAdjuster.texture = SKTexture(image: UIImage(named: "ResetButton")!)
...
//            self.gameData.bounceBars.append(newBar)
//            addChild(newBar)
//        }
//        for bar in gameData.solidBars{
//            let newBar = bar.clone()
//            self.gameData.solidBars.append(newBar)
//            addChild(newBar)
//        }
//        for bar in gameData.breakBars{
//            let newBar = bar.clone()
//            self.gameData.breakBars.append(newBar)
//            addChild(newBar)
//        }
//        for poly in gameData.polygons{
//            let newPoly = poly.clone()
//            self.gameData.polygons.append(newPoly)
//            addChild(newPoly)
//        }
//        let newEndZone = gameData.endZone.clone()
//        self.gameData.endZone = newEndZone
//        addChild(newEndZone)
//        let newBall = gameData.ball.clone()
//        self.gameData.ball = newBall
